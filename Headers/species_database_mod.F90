...
!                              RC            = RC )
          ...
          CASE( 'CLAQ' )   
             ! Give the dissolved halogens the same characteristics as other
             ! aerosol species such as NIT and NH4
          ...
          CASE( 'CLCOARSE ')
             ! Mimic SALC. This is ONLY chlorine on/in coarse sea salt
             Radius   = ( Input_Opt%SALC_REDGE_um(1) +                      &
                          Input_Opt%SALC_REDGE_um(2)  ) * 0.5e-6_fp
             ...
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              KppFixId      = KppFixId(N),                  &
                              Name          = 'ClCoarse',                   &
                              FullName      = 'Coarse sea salt chlorine',   &
                              MW_g          = 127.0_fp,                     &
                              Is_Advected   = Is_Advected,                  &
                              Is_Gas        = F,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'BRCOARSE ')
             ! Mimic SALC. This is ONLY bromine on/in coarse sea salt
             Radius   = ( Input_Opt%SALC_REDGE_um(1) +                      &
                          Input_Opt%SALC_REDGE_um(2)  ) * 0.5e-6_fp
          ...
          CASE( 'ICOARSE ')
             ! Mimic SALC. This is ONLY iodine on/in coarse sea salt
             Radius   = ( Input_Opt%SALC_REDGE_um(1) +                      &
                          Input_Opt%SALC_REDGE_um(2)  ) * 0.5e-6_fp
